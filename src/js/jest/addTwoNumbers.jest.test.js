...
describe('addTwoNumbers - jest', () => {
    it.concurrent(`should add ${TEST_NUM1} and ${TEST_NUM2} and return ${TEST_RESULT1}`, () => {
        expect(addTwoNumbers(TEST_NUM1, TEST_NUM2)).toBe(TEST_RESULT1);
    })
    it.concurrent(`should add ${TEST_NUM3} and ${TEST_NUM4} and return ${TEST_RESULT2}`, () => {
        expect(addTwoNumbers(TEST_NUM3, TEST_NUM4)).toBe(TEST_RESULT2);
    })
    it.concurrent(`should add ${TEST_NUM1} and ${TEST_NUM5} and return ${TEST_RESULT3}`, () => {
